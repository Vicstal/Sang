...
public class GUIyg extends JFrame implements ActionListener {
	// 主窗体初始界面
	...
	GUIyg(String temp) {
		...
		label.setBounds(0, 0, 770, 450);//label.setBounds(0, 0, 548, 353);
		...
		menuItem_10.setVerifyInputWhenFocusTarget(false);
		...
		menuItem_11.setVerifyInputWhenFocusTarget(false);
		...
		menuItem_7.setVerifyInputWhenFocusTarget(false);
		...
		menuItem_9.setVerifyInputWhenFocusTarget(false);
